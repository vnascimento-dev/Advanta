...
export default async function LoginPage({
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(1200px 600px at 20% 10%, rgba(0,0,0,0.06), transparent 60%), radial-gradient(900px 500px at 80% 90%, rgba(0,0,0,0.05), transparent 55%), #ffffff",
      }}
    >
          ...
          <div className="col-12 col-lg-6">
            ...
            >
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                >
                  <span style={{ fontSize: 22, fontWeight: 800 }}>A</span>
                </div>
                ...
                <div>
                  ...
                  <div className="text-muted small">Vantagem no Jurídico</div>
                </div>
              </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="d-flex gap-2 align-items-start">
                    ...
                    <div>
                      ...
                      <div>RBAC por perfil (Admin/Advogado/Assistente/Leitura)</div>
                    </div>
                  </div>
                </div>
